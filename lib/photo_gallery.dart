library photo_gallery;

import 'dart:async';

import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:photo_gallery/utils/photo_gallery_controller.dart';
import 'package:photo_gallery/utils/photo_gallery_hero_properties.dart';
import 'package:photo_gallery/widgets/gallery.dart';
import 'package:photo_gallery/widgets/gallery_overlay.dart';

class PhotoGallery {
  /// A scrollable, dismissible by swiping, zoomable, rotatable image gallery
  /// on which you can add a dynamic overlay.
  ///
  /// [PhotoGallery] utilizes [PageView] and [InteractiveViewer] for its
  /// main functionality.
  ///
  ...
  void show() async {
    if (hideStatusBar) SystemChrome.setEnabledSystemUIMode(SystemUiMode.manual, overlays: []);
