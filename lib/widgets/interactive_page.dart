...
class InteractivePage extends StatefulWidget {
  ...
  final PhotoGalleryHeroProperties? heroProperties;
...
class _InteractivePageState extends State<InteractivePage> with TickerProviderStateMixin {
  ...
  void animateDragPosition(double offsetY) {
    final _offsetTween =
        Tween<double>(begin: offsetY, end: 0).animate(_translateToCenterController);
    void animationListener() {
      setState(() => _dragPosition = Offset(0, _offsetTween.value));
  ...
  void onVerticalDragUpdateHandler(DragUpdateDetails details) {
    setState(() => _dragPosition = Offset(0.0, _dragPosition.dy + details.delta.dy));
              ...
              child: InteractiveViewer(
                ...
                child: widget.heroProperties != null
                    ? Hero(
                        ...
                        transitionOnUserGestures: widget.heroProperties!.transitionOnUserGestures,
                        child: widget.child,
                      )
                    : widget.child,
              ),
